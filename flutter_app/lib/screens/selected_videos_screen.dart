...
class SelectedVideosScreen extends StatefulWidget {
  const SelectedVideosScreen({Key? key}) : super(key: key);

  @override
  State<SelectedVideosScreen> createState() => _SelectedVideosScreenState();
}

class _SelectedVideosScreenState extends State<SelectedVideosScreen> {
  @override
  void initState() {
    super.initState();
  ...
  void _loadVideos() {
    ...
    videoService.fetchVideosByStatus('selected').catchError((e) {
      if (mounted) {
    ...
    return Scaffold(
      ...
      body: Consumer<VideoService>(
        builder: (context, videoService, _) {
          final videos =
              videoService.videos.where((v) => v.status == 'selected').toList();
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Add a video and select it to see it here',
