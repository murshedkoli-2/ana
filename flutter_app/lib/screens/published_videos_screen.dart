...
class PublishedVideosScreen extends StatefulWidget {
  const PublishedVideosScreen({Key? key}) : super(key: key);

  @override
  State<PublishedVideosScreen> createState() => _PublishedVideosScreenState();
}

class _PublishedVideosScreenState extends State<PublishedVideosScreen> {
  @override
  void initState() {
    super.initState();
  ...
  void _loadVideos() {
    ...
    videoService.fetchVideosByStatus('published').catchError((e) {
      if (mounted) {
    ...
    return Scaffold(
      ...
      body: Consumer<VideoService>(
        builder: (context, videoService, _) {
          final videos =
              videoService.videos.where((v) => v.status == 'published').toList();
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Publish videos to see them here',
